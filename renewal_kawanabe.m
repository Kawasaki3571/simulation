...
load_data = csvread('pow900_1mm_0to12kHz_180ms_fin.csv'); % 2行目より下を読み込む
noload_data = csvread('pownoload_1mm_0to12kHz_180ms_fin.csv'); % 2行目より下を読み込む
...
st_1 = st_wave:d:st_wave+1770; % スイープ波形の分割
ed_1 = st_wave+m:d:st_wave+1770+m;
