...
load_data = csvread('robot_2cm_0.2mm_0to12kHz_10ms_40deg_fin.csv'); % 2行目より下を読み込む
noload_data = csvread('robot_noload_0.2mm_0to12kHz_10ms_40deg_fin.csv'); % 2行目より下を読み込む
